    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } ?>
                <div class="col-lg-4">
                    <?php echo form_open_multipart("categories/modify", 'role="form"', $category_id);?>
                        ...
                        <div class="checkbox">
                            <label>
                                <?php echo form_checkbox($type).' '.  lang('form_cagetory_type_label');?> 
                            </label>
                        </div>
                    
                        <div class="checkbox">
                            <label>
                                <?php echo form_checkbox($display).' '.  lang('form_cagetory_display_label');?> 
                            </label>
                        </div>
                    
                        <div class="form-group">
                            <?php echo lang('form_cagetory_image_label', 'image');?> <br />
